...
export type IOnImageClickEvent = (extra: {
    url: string;
}) => void;
...
export interface IMessageCallback {
    afterMessageReceivedFinish?: (context: IMessageCallbackContext & {
        extra: {
            processChatMessageGroup: ChatMessageGroup;
        };
    }) => void;
    onRequiresAction?: (context: IMessageCallbackContext & {
        extra: {
...
export type OnLinkClickCallback = (event: ITouchEvent, eventData: LinkEventData) => void;
