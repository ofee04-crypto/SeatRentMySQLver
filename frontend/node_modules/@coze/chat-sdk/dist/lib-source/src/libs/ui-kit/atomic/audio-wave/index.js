...
export const AudioWave = ({ size = 'medium', volumeNumber = 0, type = 'default', className, }) => {
    ...
    return (_jsx(Spacing, Object.assign({ gap: 3, verticalCenter: true, horizontalCenter: true, width100: true, className: cls(styles.container, className) }, { children: waveBarHeights.map((height, index) => (_jsx(View, { className: cls(styles[`audio-wave-${index}`], styles[type], styles.bar, styles[size]), style: {
        ...
        case 'primary':
            {
                ...
                bgColor = `rgba(${rColor}, ${gColor}, ${bColor}, ${opacity.toFixed(2)})`;
            }
            break;
        case 'warning':
            {
