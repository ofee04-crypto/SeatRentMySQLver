import type { CozeAPI, StreamChatData, StreamChatReq, RequestOptions, CreateFileReq, FileObject, ChatV3Message } from '@coze/api';
...
export interface IChatService {
    ...
    translation: (params: CreateFileReq, options?: RequestOptions) => Promise<{
        text: string;
    }>;
