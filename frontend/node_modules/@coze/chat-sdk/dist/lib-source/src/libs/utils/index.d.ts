...
export { MiniChatError, MiniChatErrorCode, convertToMinChatError, } from './mini-chat-error';
export { isWeb, isWeapp, isTT, isMini, isSafari } from './device';
export { getSvgBase64 } from './get-svg-base64';
export { getRecorderManager, BaseRecorderManager, RecorderEvent, } from './recorder-manager';
